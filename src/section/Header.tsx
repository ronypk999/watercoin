...
const Header: React.FC = () => {
  ...
  return (
    <>
      <div>
        <Marquee autoFill={true} className="py-2 bg-[#2a4c75]">
     ...
     z-10 nav shadow-lg py-6 rounded-2xl text-[#2a4c75] md:text-black md:px-6"
      >
        ...
        <div
          className={`${hide ? "-right-[100rem]" : "right-0"} ${
            hide2 && "hidden"
          } absolute h-screen nav md:h-fit p-3 space-y-12 md:space-y-0 md:p-0 top-0 bottom-0 md:static md:flex items-center w-full justify-around lg:justify-between lg:px-6 font-medium bg-md-none`}
          onClick={(e) => {
            e.stopPropagation();
          }}
          style={{
